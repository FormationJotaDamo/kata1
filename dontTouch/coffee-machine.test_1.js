...
describe('Unit | Coffee Machine', () => {
  ...
  describe('#chooseDrink', () => {
    ...
    context('When the value is correct', () => {
      ...
      it('should call method printMessage with Cafe', () => {
        // Given
        const value = 1
        // When
      ...
      it('should call method printMessage with The', () => {
        // Given
        const value = 2
        // When
        machine.chooseDrink(value)
        // Then
        expect(machine.printMessage).to.have.been.calledOnce
        expect(machine.printMessage).to.have.been.calledWithExactly('Vous avez choisi la boisson :', 'Thé')
      })
